...
public class MapCatWide implements CliMain
{
    public static void main(String[] args)
    {
        new MapCatWide().run(Lists.newArrayList(args));
    }
    ...
    public void run(List<String> args)
    {
        try
        {
            ...
            String doc = "concatenate map files into rows of a table (more efficient than MapCat)";
            ...
            for (Map<String, String> group : ComboUtils.groups(vars, product))
            {
                ...
                try
                {
                    ...
                    if (!init)
                    {
                        Logging.info("creating table fields");
                        table.withFields(map.keySet());
                        init = true;
                    }
