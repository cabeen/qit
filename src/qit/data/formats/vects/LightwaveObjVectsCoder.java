...
public class LightwaveObjVectsCoder
{
    // http://paulbourke.net/dataformats/obj/

    public static void write(Vects vects, OutputStream os) throws IOException
    {
        PrintWriter pw = new PrintWriter(new BufferedOutputStream(os));
        pw.write("# A WaveFront OBJ file\n");
        pw.write("#\n");
        pw.write("# num points: " + vects.size() + "\n");
        pw.write("\n");
