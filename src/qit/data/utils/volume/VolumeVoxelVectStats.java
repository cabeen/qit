...
public class VolumeVoxelVectStats
{
    public Vect min;
    public Vect max;
    public Vect mean;
    ...
    public VolumeVoxelVectStats withInput(Volume v)
    {
        this.input = v;
        this.output = false;
    ...
    public VolumeVoxelVectStats withMask(Mask v)
    {
        this.mask = v;
        this.output = false;
    ...
    public VolumeVoxelVectStats withLabel(Integer v)
    {
        this.label = v;
        this.output = false;
    ...
    public VolumeVoxelVectStats withWeights(Volume v)
    {
        this.weights = v;
        this.output = false;
    ...
    public VolumeVoxelVectStats run()
    {
        List<Double> weights = Lists.newArrayList();
        List<Vect> values = Lists.newArrayList();
        double sumw = 0;
        ...
        Vects vv = VectsSource.create(values);
        ...
        VectsStats vs = new VectsStats().withInput(vv).withWeights(vw).run();
    ...
    public Record record(String basename)
    {
        ...
        if (this.num != null && this.num.get(0) > 0)
        {
