...
public class OdfPeakField extends StreamlineField
{
    private VectFunction peaker;
    private VolumeKernelModelEstimator estimator;

    public OdfPeakField(VolumeKernelModelEstimator sampler, Vects mypoints)
    {
        VolumeOdfPeaks runner = new VolumeOdfPeaks();
        runner.points = mypoints.copy();

        this.peaker = runner.factory().get();
