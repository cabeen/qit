...
public class OdfField extends StreamlineField
{
    private Vects points;
    private VolumeKernelModelEstimator estimator;

    public OdfField(VolumeKernelModelEstimator myestimator, Vects mypoints)
    {
    ...
    public List<StreamSample> getLines(Vect pos, Vect ref)
    {
        ...
        if (estimate != null)
        {
            ...
            {
                lines.add(new PointSample(pos, this.points.get(idx).copy(), estimate.get(idx)));
            }
        }
        return lines;
    }
