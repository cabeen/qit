...
/** axial k-means clustering */
public class VectsClusterAKM extends VectsClusterKM
{
    public VectsClusterAKM proto()
    {
        return new VectsClusterAKM().with(this);
    }
    
    public VectsClusterAKM with(VectsCluster set)
    {
        super.with(set);
    ...
    public VectsClusterAKM maximization()
    {
        ...
        for (int i = 0; i < this.vects.size(); i++)
        {
            ...
            dyads[idx].plusEquals(weight, MatrixSource.dyadic(this.vects.get(i)));
        ...
        for (int i = 0; i < this.k; i++)
        {
            ...
            Vect axis = dyads[i].times(norm).prineig();
            this.centers.get(i).set(axis);
        }
