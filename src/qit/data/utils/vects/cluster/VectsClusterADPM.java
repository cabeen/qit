...
/** axial dp-means clustering */
public class VectsClusterADPM extends VectsClusterDPM
{
    public VectsClusterADPM proto()
    {
        return new VectsClusterADPM().with(this);
    }

    public VectsClusterADPM with(VectsCluster set)
    {
        super.with(set);
        return this;
    }
    ...
    public VectsClusterADPM maximization()
    {
