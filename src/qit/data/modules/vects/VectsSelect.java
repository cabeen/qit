...
@ModuleDescription("Select a which of vects")
@ModuleAuthor("Ryan Cabeen")
public class VectsSelect implements Module
{
    @ModuleInput
    ...
    @ModuleOutput
    @ModuleDescription("output selected vects")
    public Vects output;

    @Override
    public VectsSelect run()
    {
        Containable selector = SelectorSource.constant(true);
        ...
        this.output = VectsUtils.select(this.input, selector);
        return this;
    }
}
