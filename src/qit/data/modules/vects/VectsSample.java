...
@ModuleDescription("Sample a volume at a set of points")
@ModuleAuthor("Ryan Cabeen")
public class VectsSample implements Module
{
    @ModuleInput
    @ModuleDescription("input 3D coordinates")
    private Vects input;
    ...
    @ModuleOutput
    @ModuleDescription("the output samples")
