...
@ModuleDescription("Standardize the pose of a mask")
@ModuleAuthor("Ryan Cabeen")
public class MaskStandardize implements Module
{
    @ModuleInput
    ...
    public MaskStandardize run()
    {
        ...
        Mask maskOut = new Mask(standard);
        for (Sample sample : standard)
        {
            maskOut.set(sample, this.input.get(sample));
        }
