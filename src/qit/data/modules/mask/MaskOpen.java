...
@ModuleDescription("Open a mask using morphological operations.  This first erodes the mask and then dilates it.")
@ModuleAuthor("Ryan Cabeen")
public class MaskOpen implements Module
{
    @ModuleInput
    ...
    public static Mask apply(Mask mask, int num, boolean large)
    {
        return new MaskOpen()
        {{
            this.input = mask;
