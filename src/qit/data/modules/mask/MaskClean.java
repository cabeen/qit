...
public class MaskClean implements Module
{
    @ModuleInput
    ...
    @Override
    public MaskClean run()
    {
        Mask mask = this.input;

        MaskOpen opener = new MaskOpen();
        opener.input = mask;
        opener.element = this.element;
        opener.num = this.num;
        opener.outside = this.outside;
        mask = opener.run().output;
