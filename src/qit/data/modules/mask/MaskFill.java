...
@ModuleDescription("Flood fill the interior of the mask regions")
@ModuleAuthor("Ryan Cabeen")
public class MaskFill implements Module
{
    @ModuleInput
    ...
    public MaskFill run()
    {
        ...
        Mask invert = MaskUtils.invert(mask);
        ...
        {
            int comp = comps.get(sample);
            if (mask.foreground(sample) || comp > 1)
            {
                out.set(sample, 1);
            }
        }
