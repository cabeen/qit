...
@ModuleDescription("Detect the edges of a input mask")
@ModuleAuthor("Ryan Cabeen")
public class MaskEdge implements Module
{
    @ModuleInput
    ...
    @ModuleParameter
    @ModuleDescription("binarize the edges")
    public boolean binary = false;

    @ModuleParameter
    @ModuleDescription("use a full neighborhood")
    ...
    public MaskEdge run()
    {
        ...
        if (this.binary)
        {
            MaskBinarize biner = new MaskBinarize();
            biner.input = out;
            out = biner.run().output;
        }
