...
@ModuleDescription("Mirror a mask is the given direction")
@ModuleAuthor("Ryan Cabeen")
public class MaskMirror implements Module
{
    @ModuleInput
    ...
    public MaskMirror run()
    {
        ...
        this.output = MaskUtils.combine(this.input, out, true);
    ...
    {
        MaskMirror comper = new MaskMirror();
        comper.input = mask;
