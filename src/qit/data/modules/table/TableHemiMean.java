...
@ModuleDescription("Compute the left-right average of a lateralized dataset")
@ModuleAuthor("Ryan Cabeen")
public class TableHemiMean implements Module
{
    @ModuleInput
    ...
    public TableHemiMean run()
    {
        ...
        for (Integer key : this.input.keys())
        {
            ...
            for (Triple<String, String, String> map : mapping)
            {
                ...
                try
                {
                    ...
                    myoutput.with(newKey, meanValue);
                }
        ...
        Logging.infosub("number of valid records: %d", output.getNumRecords());
