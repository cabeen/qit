...
public class MapLaterality implements Module
{
    @ModuleInput
    ...
    public MapLaterality run()
    {
        ...
        for (String leftKey : map.keySet())
        {
            if (leftKey.contains(this.left))
            {
                ...
                String indlatKey = leftKey.replace(this.left, this.indlat);
                String abslatKey = leftKey.replace(this.left, this.abslat);
                String unilatKey = leftKey.replace(this.left, this.unilat);
                String minlatKey = leftKey.replace(this.left, this.minlat);
                String maxlatKey = leftKey.replace(this.left, this.maxlat);
                ...
                if (map.containsKey(rightKey))
                {
                    ...
                    output.addRecord(new Record().with(this.name, indlatKey).with(this.value, indlatValue));
                    output.addRecord(new Record().with(this.name, abslatKey).with(this.value, abslatValue));
                    output.addRecord(new Record().with(this.name, unilatKey).with(this.value, uniValue));
                    output.addRecord(new Record().with(this.name, minlatKey).with(this.value, minValue));
                    output.addRecord(new Record().with(this.name, maxlatKey).with(this.value, maxValue));
                }
                else
                {
