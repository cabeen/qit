...
@ModuleDescription("Compute a mask by voxelizing curves.  This works by find the voxels that intersect the curves and marking them as one.")
@ModuleAuthor("Ryan Cabeen")
public class CurvesVoxelize implements Module
{
    @ModuleInput
    ...
    public CurvesVoxelize run()
    {
        ...
        Mask mask = MaskUtils.voxelize(sampling, this.input);
