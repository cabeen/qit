...
@ModuleDescription("Sample a volume at the vertices of curves")
@ModuleAuthor("Ryan Cabeen")
public class CurvesSample implements Module
{
    @ModuleInput
    ...
    @ModuleParameter
    @ModuleDescription("attribute name")
    public String attr = "sampled";
    ...
    public Module run()
    {
        ...
        VectFunction func = VolumeUtils.interp(this.interp, this.volume);
        new CurvesFunctionSample().withCurves(curves).withFunction(func).withAttribute(this.attr).run();
        this.output = curves;
