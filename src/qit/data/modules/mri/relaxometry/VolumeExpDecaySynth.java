...
public class VolumeExpDecaySynth implements Module
{
    @ModuleInput
    @ModuleDescription("input exp decay volume")
    public Volume input;
    ...
    @Override
    public VolumeExpDecaySynth run()
    {
        this.output = new VolumeFunction(ExpDecay.synth(this.varying.flatten())).withInput(this.input).withMask(this.mask).run();
