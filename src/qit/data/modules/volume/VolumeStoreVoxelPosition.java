...
@ModuleDescription("Create a volume storing the 3D world coordinates of each voxel")
@ModuleAuthor("Ryan Cabeen")
public class VolumeStoreVoxelPosition implements Module
{
    @ModuleInput
    ...
    public VolumeStoreVoxelPosition run()
    {
        ...
        {
            out.set(sample, sampling.world(sample));
        }
