...
@ModuleDescription("Resample a volume with a different voxel size")
@ModuleAuthor("Ryan Cabeen")
public class VolumeResample implements Module
{
    @ModuleInput
    ...
    public Module run()
    {
        ...
        Sampling nsampling = sampling.resample(this.dx, this.dy, this.dz);
