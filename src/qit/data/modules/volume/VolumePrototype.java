...
public class VolumePrototype implements Module
{
    @ModuleInput
    ...
    @ModuleParameter
    @ModuleDescription("the output volume dimension")
    ...
    public VolumePrototype run()
    {
        this.output = this.dim != null ? this.input.proto(dim) : this.input.proto();
