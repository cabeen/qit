...
@ModuleDescription("Compute geometric features of a mesh at each vertex using implicit modeling")
@ModuleAuthor("Ryan Cabeen")
public class VolumeFeaturesImplicit
{
    @ModuleInput
    ...
    public VolumeFeaturesImplicit run()
    {
        ...
        VectFunction interpf = VolumeUtils.interp(InterpolationType.Trilinear, this.input);
        ...
        {
            out.set(sample, func.apply(sampling.world(sample)));
        }
