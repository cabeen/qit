...
public class VolumeThresholdRange implements Module
{
    @ModuleInput
    ...
    public Double lower = 0.25;

    @ModuleParameter
    @ModuleDescription("threshold value")
    public Double upper = 0.75;
    ...
    public VolumeThresholdRange run()
    {
        ...
        Mask lowerMask = VolumeThreshold.apply(volume, this.mask, this.lower, this.magnitude);
        Mask upperMask = VolumeThreshold.apply(volume, this.mask, this.upper, this.magnitude);
        Mask out = MaskUtils.and(MaskUtils.invert(lowerMask), upperMask);
