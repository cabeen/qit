...
@ModuleDescription("Get the pose (orientation and origin) of a volume")
@ModuleAuthor("Ryan Cabeen")
public class VolumePoseGet implements Module
{
    @ModuleInput
    ...
    @ModuleOutput
    @ModuleDescription("the output affine xfm")
    private Affine output;
    ...
    public Module run()
    {
        ...
        this.output = new Affine(quat, start);
