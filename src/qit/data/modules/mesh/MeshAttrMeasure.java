...
public class MeshAttrMeasure implements Module
{
    @ModuleInput
    ...
    @ModuleInput
    @ModuleOptional
    @ModuleDescription("add a pacellation attribute")
    public Vects labels;

    @ModuleParameter
    @ModuleDescription("treat the parcellation as binary (zero vs. non-zero)")
    public boolean binary = false;

    @ModuleInput
    @ModuleOptional
    @ModuleDescription("use a lookup table for naming regions")
    public Table lookup;

    @ModuleParameter
    @ModuleDescription("the lookup table name field")
    public String lutname = "name";

    @ModuleParameter
    @ModuleDescription("the lookup table index field")
    ...
    @Override
    public MeshAttrMeasure run() throws IOException
    {
