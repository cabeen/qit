...
@ModuleDescription("Manipulate mesh vertex attributes.  Operations support comma-delimited lists")
@ModuleAuthor("Ryan Cabeen")
public class MeshAttributes implements Module
{
    @ModuleInput
    ...
    public MeshAttributes run()
    {
        ...
        if (this.remove != null)
        {
            ...
            {
                Global.assume(attr != Mesh.COORD, "cannot remove coordinate attribute");
        ...
        if (this.retain != null)
        {
            ...
            attrs.add(Mesh.COORD); // always keep the coordinates

            for (String attr : Sets.newHashSet(mesh.vattr.attrs()))
            {
