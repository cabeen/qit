...
@ModuleDescription("Open a mesh selection")
@ModuleAuthor("Ryan Cabeen")
public class MeshAttrOpen implements Module
{
    @ModuleInput
    ...
    @Override
    public MeshAttrOpen run()
    {
        Mesh mesh = this.inplace ? this.input : this.input.copy();

        Logging.info("started mesh selection opening");

        {
            MeshAttrErode module = new MeshAttrErode();
            module.input = mesh;
            module.attrin = this.attrin;
            module.attrout = this.attrout;
            module.num = this.num;
            module.inplace = this.inplace;
            mesh = module.run().output;
        }
        ...
        {
            MeshAttrDilate module = new MeshAttrDilate();
            module.input = mesh;
            module.attrin = this.attrin;
            module.attrout = this.attrout;
            module.num = this.num;
        ...
        Logging.info("finished mesh selection opening");
