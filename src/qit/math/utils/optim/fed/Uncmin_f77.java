...
import qit.math.utils.optim.fed.Uncmin_methods;
...
*/
     ...
     * @param fscale   Estimate of the scaleCamera of the objective function
...
// FIND I,J ELEMENT OF LOWER TRIANGULAR MATRIX
     ...
     * @param typsiz Typical size for each component of x
     * @param fscale Estimate of the scaleCamera of the minimization function
     * @param method Algorithm to use to solve the minimization problem
...
// gradient
     ...
     * @param fscale   Estimate of scaleCamera of f_to_minimize
...
*/
     ...
     * @param sx     Scaling vector for x
     * @param fscale Estimate of scaleCamera of objective function
...
// (IF IAGFLG .EQ. 1) OR SNDOFD (OTHERWISE).
            ...
            if ((msg[1] / 8) % 2 == 0)
            {
                Uncmin_f77.result_f77(n, x, f, g, a,
                        p, itncnt, 1);
            }
