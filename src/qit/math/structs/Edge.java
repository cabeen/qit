...
public class Edge
{
    ...
    public Edge(Vertex a, Vertex b)
    {
        if (a.equals(b))
        {
            throw new RuntimeException("vertices cannot be equal");
        }
    ...
    public Vertex opposite(Vertex v)
    {
        ...
        {
            throw new RuntimeException("edge doesn't contain the vertex");
        }
    }

    public boolean connected(Edge e)
    {
        return this.contains(e.a) || this.contains(e.b);
    }
