...
public class DeformationView extends AbstractView<Deformation>
{
    ...
    protected ControlPanel makeInfoControls()
    {
        ...
        final BasicLabel info = new BasicLabel("");
        infoPanel.addControl("info: ", info);
        this.observable.addObserver((o, arg) ->
        {
            if (DeformationView.this.hasData())
            {
                info.setText(DeformationView.this.data.toString());
            }
            else
            {
                info.setText("no dataset found");
            }
        });
    ...
    @Override
    public synchronized Deformation getData()
    {
        return this.data;
    }
}
