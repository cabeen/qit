...
%
%   Ci     = modularity_probtune_und_sign(W,qtype,Ci0,p);
%   [Ci Q] = modularity_probtune_und_sign(W,qtype,Ci0,p);
%
...
%   Mar 2011: Original
%   Jan 2015: Modified 'unique' statement to align with MATLAB >2013 behavior
...
M=M(:).';                                                   %ensure row-vector orientation
